...
class DashboardCountryDetail extends React.Component<DashboardCountryDetailData & DashboardPageHandlers, object> {
    render() {
        return <div className="DashboardCountryDetail">
    ...
    renderSelectedCountry() {
        ...
        if (p.selectedCountry) {
            return <div className="DashboardCountryDetail-ProfileTitle">Developer profile in {p.selectedCountry.name}</div>
        }
        return undefined;
    }
    ...
    renderMeanDevInfo(): React.ReactNode {
        ...
        if (p.meanDev) {
            return <Grid className="DashboardCountryDetail-ProfileInfo">
