...
abstract class AbstractChart<T> extends React.Component<ChartProps<T>, object> {
    ...
    private renderMeanLine() {
        ...
        this.plotGroup.selectAll('line[data-type=mean-line],text[data-type=mean-line]')
            .remove();

        this.plotGroup.append('line')
            .attr('data-type', 'mean-line')
            .attr('x1', this.xScale(p.data.meanValue))
            .attr('y1', 0)
            .attr('x2', this.xScale(p.data.meanValue))
        ...
        this.plotGroup.append('text')
            .attr('data-type', 'mean-line')
            .attr('x', this.xScale(p.data.meanValue) + meanLineParams.textShiftX)
